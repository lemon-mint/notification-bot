...
func (uu *UserUpdate) AddChannelIDs(ids ...int) *UserUpdate {
...
func (uu *UserUpdate) RemoveChannelIDs(ids ...int) *UserUpdate {
...
// AddChannelIDs adds the "Channels" edge to the Channel entity by IDs.
func (uuo *UserUpdateOne) AddChannelIDs(ids ...int) *UserUpdateOne {
...
// RemoveChannelIDs removes the "Channels" edge to Channel entities by IDs.
func (uuo *UserUpdateOne) RemoveChannelIDs(ids ...int) *UserUpdateOne {
